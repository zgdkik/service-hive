 ...
 */
package com.netflix.ribbon.ext.rule;

import com.netflix.ribbon.ext.predicate.DiscoveryEnabledPredicate;
import com.netflix.ribbon.ext.predicate.MetadataAwarePredicate;
